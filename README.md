...
If you provide a non-workflow token, also set `github_token_actor` so the agent can recognize its own comments. If you omit it, the action assumes `github-actions[bot]`.
